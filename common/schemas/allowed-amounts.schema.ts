// object contents copy-pasted as-is from https://github.com/CMSgov/price-transparency-guide/blob/master/schemas/allowed-amounts/allowed-amounts.json
// ! note `as const` at the end
// this file will not go to any build since should be imported as type only
export const AllowedAmountsSchema = {
